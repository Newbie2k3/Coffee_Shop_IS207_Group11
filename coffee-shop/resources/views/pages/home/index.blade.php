<x-guest-layout>
    ...
    <section class="flex p-5">
        ...
        <div class="px-6">
            ...
            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Suscipit minima obcaecati eligendi ratione
                possimus
                illo dolorum iste amet dicta, fugiat laudantium soluta debitis! Ad incidunt dignissimos dolorem placeat
    ...
    <section class="menu">
        <div class="flex px-5 py-5">
            <div>
                <p class="fs-2 text-end title-tertiary">Discover</p>
                <p class="fs-2 text-end title-primary">OUR MENU</p>
                <p class="text-end">Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio tempora numquam
                    facere
            ...
            <div class="image-container">
                <img src="https://neurosciencenews.com/files/2023/06/coffee-brain-caffeine-neuroscincces.jpg"
                    alt="">
                <img src="https://file.hstatic.net/1000075078/article/blog_f80b599183c340bca744c174e7ab2af8.jpg"
                    alt="">
                <img src="https://hips.hearstapps.com/hmg-prod/images/1519246658-irish-coffee-delish-1620163679.jpeg?crop=0.8890666666666666xw:1xh;center,top&resize=1200:*"
                    alt="">
